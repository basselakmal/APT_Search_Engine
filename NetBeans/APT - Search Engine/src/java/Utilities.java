...
public class Utilities {
    ...
    Vector<Page> SortPages(Vector<Page> Pages, String Param){

        Vector<Page> SortedPages = new Vector<Page>();
        ...
        while(Pages.size()>0) {
            ...
            for (int i = 0; i < Pages.size(); i++) {
                ...
                if (Param.equals("TF_IDF")) {
                    if (Pages.get(i).getTF_IDF() > Max.getTF_IDF()) {
                        Max = Pages.get(i);
                        Max_Index = i;
                    }
                } else if (Param.equals("PageRank")) {
                    if (Pages.get(i).getPageRank() > Max.getPageRank()) {
                        Max = Pages.get(i);
                        Max_Index = i;
                    }
                }
            ...
            SortedPages.add(Max);
            Pages.removeElementAt(Max_Index);
        }
        return SortedPages;
    }
}
